...
COMPATIBILITY_IMPORTS: tuple[CompatibilityImport, ...] = (
    ...
    CompatibilityImport("agent_memory_orchestrator.config", "agent_memory_orchestrator.core.config", "core"),
    CompatibilityImport("agent_memory_orchestrator.db", "agent_memory_orchestrator.core.db", "core"),
    CompatibilityImport("agent_memory_orchestrator.models", "agent_memory_orchestrator.core.models", "core"),
    CompatibilityImport("agent_memory_orchestrator.privacy", "agent_memory_orchestrator.core.privacy", "core"),
    ...
    CompatibilityImport("agent_memory_orchestrator.memory_service", "agent_memory_orchestrator.memory", "memory"),
    CompatibilityImport("agent_memory_orchestrator.context_pack", "agent_memory_orchestrator.retrieval", "retrieval"),
