...
from .commands.peer import peer_invite_from_setup_args as _peer_invite_from_setup_args
from .commands.peer import peer_netd_options_from_args as _peer_netd_options_from_args
from .commands.peer import peer_netd_service_options_from_args as _peer_netd_service_options_from_args
from .commands.peer import peer_relay_options_from_args as _peer_relay_options_from_args
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.command == "production" and args.production_command == "export-fixture":
            settings = Settings.load()
        ...
        if args.command == "production" and args.production_command == "semantic-eval":
            settings = Settings.load()
        ...
        if args.command == "production" and args.production_command == "eval":
            settings = Settings.load()
        ...
        if args.command == "production" and args.production_command == "merge-plan":
            settings = Settings.load()
            if args.backfill:
        ...
        if args.command == "production" and args.production_command == "merge-apply":
            settings = Settings.load()
